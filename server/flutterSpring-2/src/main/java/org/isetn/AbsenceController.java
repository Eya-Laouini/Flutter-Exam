...
public class AbsenceController {
    ...
    // New method to get total absence hours for a student
    @GetMapping("/totalHoursByStudent/{etudiantId}")
    public ResponseEntity<Integer> getTotalAbsenceHoursByStudent(@PathVariable Long etudiantId) {
        try {
            // You can modify the query to sum up all absence hours for a specific student
